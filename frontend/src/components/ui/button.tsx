  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 group relative overflow-hidden',
  {
    variants: {
      variant: {
        ...
        outline:
          'border border-neutral-200 bg-surface-primary text-neutral-700 shadow-sm hover:bg-neutral-50 hover:border-neutral-300 hover:shadow-md hover:-translate-y-0.5 active:translate-y-0',
        secondary:
          'bg-neutral-100 text-neutral-700 shadow-sm hover:bg-neutral-200 hover:shadow-md hover:-translate-y-0.5 active:translate-y-0',
        ghost: 'text-neutral-600 hover:bg-neutral-100 hover:text-neutral-900 hover:shadow-sm',
